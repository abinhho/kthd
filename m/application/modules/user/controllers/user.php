...
class User extends MX_Controller {
	...
	public function login(){
       ...
       $this->template->write('title', "Đăng nhập tài khoản", true);
	   ...
	   $submit_login = $this->input->post('submit_login');
		...
		$this->load->view("user_form_login", $data);
	}
    public function register(){
       ...
       $this->template->write('title', "Đăng ký tài khoản", true);
	   ...
	   $submit_register = $this->input->post('submit_register');
		...
		$this->load->view("user_form_register", $data);
	}
