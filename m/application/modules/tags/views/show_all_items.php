...
<span class="block f_font1 font15 pd_10 bold" style="margin: 10px 0 20px;"><?php echo $description ?></span>
<div class="bound_ul">
<?php  foreach($items as $row){
    ...
    foreach ($row['tags']['items'] as $r)
    {
     ...
     ?>
    <div class="block pd_0_10 clearfix"><a href="<?php echo $link_more ?>" class="font12 "> >xem thêm</a></div>
    </ul>
