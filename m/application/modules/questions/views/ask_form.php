...
?>
<h1 class="title_view_questions pd_0_10 f_font1">Chỉnh sửa, thêm bài viết

<?php if(!empty($back_url)) { ?><a class="right mg_top_5" href="<?php echo $back_url ?>">Quay lại câu hỏi</a> <?php } ?>
</h1>
<form action="" name="" id="form_ask_question" enctype='multipart/form-data' method="POST" class="form_bg pd_0_10 mod_questions relative">
...
<table width="100%" cellspacing="0" cellpadding="0">
	...
	<tr class="nda">
        ...
        <textarea class="area_mobile" id="#cke_noi_dung" name="noi_dung"><?php echo @$noi_dung?></textarea>
