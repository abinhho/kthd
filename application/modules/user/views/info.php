    ...
    <table width="100%" cellpadding="4">
        <tr>
            ...
            <div class="score_info">
                <span class="score_" t_title="Danh tiếng"><i class="fa fa-star-half-full"></i> <?php echo $score ?></span>
                <span class="question_"  t_title="Đã hỏi"><i class="fa fa-pencil-square-o"></i> <?php echo $n_questions ?></span>
                <span class="answer_"  t_title="Đã trả lời"><i class="fa fa-mail-reply-all"></i> <?php echo $n_answers ?></span>
            </div>
            </div>
            </td>
