...
<div class="footer">
<i class="fa fa-star-half-full"></i> <b><?php echo $score ?></b><span class="gray font12"> (danh tiếng)</span>
 <i class="fa fa-pencil-square-o"></i> <b><?php echo $n_questions ?></b><span class="gray font12"> (câu hỏi)</span>
 <i class="fa fa-mail-reply-all"></i> <b><?php echo $n_answers ?></b><span class="gray font12"> (trả lời)</span>
</div>
