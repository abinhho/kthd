<h5 class="font18 mg_bottom_10 f_font1" id="form-answer">Trả lời câu hỏi này</h5>
<?php if($this->lib_auth->check_permission()) : ?>

<form action="" name="" id="form_answer" enctype='multipart/form-data' method="POST" class="form_bg mod_questions form_ans after">
<div class="after"> 
	...
	<div class="rfloat after mg_top_10">
		...
		<input type="submit" id="newpost" name="submit_answer" class="button mg_top_10 rfloat" <?php echo $submit?> value="Gửi câu trả lời" />
	</div>
</div>
