<?php if(count($item_comments)): ?>
<div class="item_comments clearfix" id="item_comments_<?php echo $type.'_'.$id  ?>">
<ul>
<?php 
$i = 0;
...
<a href="javascript:void(0)" id="comment_topic" t_title = "Bình luận"><i class="fa fa-comments-o"></i> viết bình luận</a>
</div>
