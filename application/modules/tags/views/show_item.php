...
<span class="block f_font1 font15 bold color55" style="margin: 10px 0 20px;">Tất cả các tag trong <?php echo $cata_name; ?> 
<a class="rfloat f_normal font14" rel="nofollow" href="<?php echo base_url('tags') ?>">Quay lại danh mục</a>
</span>
<ul class="after">
